...
import io.github.idoly.sqlite.internal.DatabaseMetaDataImpl.ImportedKeyFinder.ForeignKey;
...
public final class DatabaseMetaDataImpl implements DatabaseMetaData {
    ...
    public ResultSet getColumns(String c, String s, String tblNamePattern, String colNamePattern)
            ...
            while (rs.next()) {
                ...
                try (Statement colstat = conn.createStatement();
                    ...
                    for (int i = 0; rscol.next(); i++) {
                         ...
                         */
                        colType = colType == null ? "TEXT" : colType.toUpperCase(Locale.ROOT);
        ...
        return ((StatementImpl) stat).executeQuery(sql.toString(), true);
    }
    ...
    public ResultSet getCrossReference(
        ...
        return ((StatementImpl) conn.createStatement()).executeQuery(query, true);
    }
    ...
    public ResultSet getPrimaryKeys(String c, String s, String table) throws SQLException {
        ...
        return ((StatementImpl) stat).executeQuery(sql.append(") order by cn;").toString(), true);
    }
    ...
    public ResultSet getExportedKeys(String catalog, String schema, String table)
        ...
        sql.append("select ")
                ...
                .append(" as PK_NAME, ")
                .append(DatabaseMetaData.importedKeyNotDeferrable)
    ...
    public ResultSet getImportedKeys(String catalog, String schema, String table)
        ...
        for (; rs.next(); i++) {
            ...
            sql.append("select ")
                    ...
                    .append(DatabaseMetaData.importedKeySetDefault)
                    .append(" end as dr, ")
                    .append(fkName == null ? "''" : quote(escape(fkName)))
                    .append(" as fkn, ")
                    .append(pkName == null ? "''" : quote(escape(pkName)))
                    .append(" as pkn");
        }
        rs.close();
    ...
    public synchronized ResultSet getTables(
        ...
        if (types != null && types.length != 0) {
            ...
            sql.append(
                    Arrays.stream(types)
                            .map((t) -> "'" + escape(t.toUpperCase(Locale.ROOT)) + "'")
                            .collect(Collectors.joining(",")));
            sql.append(")");
        }
        ...
        return ((StatementImpl) conn.createStatement()).executeQuery(sql.toString(), true);
    }
                    ...
                    ResultSet rs =
                            stat.executeQuery(
                                    "pragma foreign_key_list('"
                                            + escape(this.fkTableName.toLowerCase(Locale.ROOT))
                                            + "')")) {
