...
This module vendors the SQLite 3.53.4 amalgamation. `src/main/c/SQLITE_SHA256` records the checksum of the upstream ZIP used to populate the source files.
